...
function filterSelect() {
  ...
  if (imageIsLoaded(fimage)) {
    ...
    if (selected === "grayscale") { grayscale(); }
    else if (selected === "sepia") { sepia(); }
    else if (selected === "rainbow") { rainbow(); }
    else if (selected === "red") { red(); }
    else if (selected === "blur") { blur(); }
    else if (selected === "windowPane") { windowPane(); }
    else if (selected === "colorize") { colorize(); }
    else { alert("Select Filter"); }
...
function windowPane() {
  for (var pixel of fimage.values()) {
    ...
    if ((pixel.getX() < 40) || (pixel.getX() < fimage.getWidth() && pixel.getX() > fimage.getWidth() - 40) || (pixel.getY() < 40) || (pixel.getY() < fimage.getHeight() && pixel.getY() > fimage.getHeight() - 40) || (pixel.getX() < fimage.getWidth() / 4 && pixel.getX() > fimage.getWidth() / 4 - 30) || (pixel.getX() < fimage.getWidth() / 2 && pixel.getX() > fimage.getWidth() / 2 - 30) || (pixel.getX() < (fimage.getWidth() * 3) / 4 && pixel.getX() > (fimage.getWidth() * 3) / 4 - 30) || (pixel.getY() < fimage.getHeight() / 2 && pixel.getY() > fimage.getHeight() / 2 - 30)) {
      pixel.setRed(0);
      pixel.setGreen(0);
      pixel.setBlue(0);
    }
